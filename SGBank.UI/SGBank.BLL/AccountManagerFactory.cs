...
namespace SGBank.BLL
{
     public static class AccountManagerFactory
     {
        //Most factory classes name their primary method Create() since it creates an object.
         ...
         {
             string mode = ConfigurationManager.AppSettings["BasicTest"].ToString(); //Opens up appconfig, and looks at app setting and pulls value assigned to the Mode key and puts it into the string
